        ...
        <section className={clsx(isLoaded && 'fade-in-start')}>
          <div className='layout min-h-main py-20'>
            ...
            <p className='mt-2 text-gray-600 dark:text-gray-300' data-fade='1'>
              We maintain a vibrant, enjoyable and active Christian life. A life
              so satisfying and fulfilling! Whether you're a growing family or a
              student, single or retired, you have a place to live, grow, and
              serve as an indispensable member of Christ's Body.{' '}
              <Accent>
            ...
            >
              {ourLife.map((snippet, i) => (
                <OurLifeCard key={snippet.title} snippet={snippet} index={i} />
              ))}
            </ul>
          </div>
        </section>
